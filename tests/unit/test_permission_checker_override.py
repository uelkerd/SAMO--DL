...
def test_permission_override_header_active_under_pytestmonkeypatch:
    ...
    assert access and isinstanceaccess, str, "Missing access_token in login response"
...
def test_permission_override_header_inactive_without_pytestmonkeypatch:
    ...
    access = login_resp.json().get"access_token"
    assert access and isinstanceaccess, str
