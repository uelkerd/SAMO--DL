...
def update_metrics(response_time, success=True, emotion=None, error_type=None, rate_limited=False, sanitization_warnings=0) -> None:
...
def register_provider(name, factory) -> None:
