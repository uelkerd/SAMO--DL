...
def serve_openapi_spec():
    ...
    abs_spec_path = os.path.abspathspec_path
    ...
    try:
        ...
        with openabs_spec_path, 'r', encoding='utf-8' as f:
            content = f.read()
        # Use a standard YAML mimetype
        return Responsecontent, mimetype='application/x-yaml'
