...
class User(Base):
    ...
    voice_transcriptions = relationship("VoiceTranscription", back_populates="user", cascade="all, delete-orphan")
...
class JournalEntry(Base):
    ...
    embeddings = relationship("Embedding", back_populates="journal_entry", cascade="all, delete-orphan")
