...
class DataValidator:
    ...
    def check_missing_values(self, 
                             df: pd.DataFrame, 
                             required_columns: List[str] = None) -> Dict[str, float]:
        """
    ...
    def check_data_types(self, 
        ...
        for column, expected_type in expected_types.items():
            ...
            elif expected_type == str and pd.api.types.is_string_dtype(actual_type):
                type_check_results[column] = True
            else:
    ...
    def validate_journal_entries(self, 
                                ...
                                expected_types: Dict[str, type] = None) -> Tuple[bool, pd.DataFrame]:
        """
