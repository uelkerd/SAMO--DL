...
class ModelValidator:
    ...
    def validate_model_structure(self, model: nn.Module) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            if type(model).__name__ not in self.allowed_model_types:
                validation_info['issues'].append(f"Model type {type(model).
                    __name__} not allowed")
    ...
    def validate_model_file(self, model_path: str) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            if file_size_mb > self.max_model_size_mb:
                validation_info['issues'].append(f"Model file too large: {file_size_mb:.
                    2f}MB")
            ...
            try:
                ...
                if not isinstance(model_data, dict):
                    validation_info['issues'].
                        append("Model file is not a valid state dict")
                else:
                    # Check for required keys
                    if 'state_dict' not in model_data:
                        validation_info['issues'].
                            append("Model file missing state_dict")
    ...
    def validate_version_compatibility(self, model_config: Dict[str, Any]) -> Tuple[bool,
        Dict]:
        ...
        try:
            ...
            if validation_info['compatibility_issues']:
                validation_info['issues'].
                    extend(validation_info['compatibility_issues'])
    ...
    def comprehensive_validation(self,
        ...
        try:
            ...
            version_valid,
                version_info = self.validate_version_compatibility(model_config)
            ...
            if file_valid:
                try:
                    ...
                    valid_params = {k: v for k,
                        v in model_config.items() if k in constructor_params}
                    ...
                    structure_valid,
                        structure_info = self.validate_model_structure(model)
