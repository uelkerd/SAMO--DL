...
class AudioPreprocessor:
    ...
    def preprocess_audio(
        ...
        if audio.frame_rate != AudioPreprocessor.TARGET_SAMPLE_RATE:
            ...
            logger.info(f"Resampled to {AudioPreprocessor.TARGET_SAMPLE_RATE}Hz")
...
class WhisperTranscriber:
    ...
    def __init__(
        ...
        logger.info(f"Initializing Whisper {self.config.model_size} model...")
        ...
        try:
            ...
            logger.info(f"✅ Whisper {self.config.model_size} model loaded successfully")
    ...
    def transcribe_audio(
        ...
        try:
            ...
            logger.info(f"✅ Transcription complete: {word_count} words, {confidence:.2f} confidence")
            logger.info(f"Processing time: {processing_time:.2f}s, Quality: {audio_quality}")
...
def create_whisper_transcriber(
    ...
    logger.info(f"Created Whisper transcriber: {model_size}")
