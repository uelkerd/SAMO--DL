...
from .dataset_loader import GoEmotionsDataLoader, create_goemotions_loader, GOEMOTIONS_EMOTIONS
...
class EmotionDetectionTrainer:
    ...
    def prepare_data(self) -> Dict[str, any]:
        ...
        logger.info(f"Prepared datasets - Train: {len(self.train_dataset)}, "
    ...
    def initialize_model(self, class_weights: Optional[np.ndarray] = None) -> None:
        ...
        logger.info(f"Model initialized with {self.model.count_parameters():,} trainable parameters")
