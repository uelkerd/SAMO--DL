...
def validate_environment():
    ...
    try:
        ...
        logger.info(f"✅ Vertex AI: Available")
...
def validate_data_distribution():
    ...
    try:
        ...
        logger.error(f"❌ Data distribution validation failed: {e}")
        return False
...
def validate_loss_function():
    ...
    try:
        ...
        if loss_diff > 1.0:
            logger.warning(f"⚠️  Large difference between custom and manual loss: {loss_diff}")
