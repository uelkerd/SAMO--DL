#!/usr/bin/env python3
"""
Create a bulletproof Colab notebook that handles NumPy 2.x compatibility issues
"""
...
def create_bulletproof_notebook():
    """Create a Colab notebook with NumPy 2.x compatibility fixes"""
        ...
        "cells": [
            {
                ...
                "metadata": {},
                "source": [
                    "# 🚀 **BULLETPROOF EMOTION DETECTION TRAINING**\n",
                    "\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "\n",
                    "This cell handles NumPy 2.x compatibility and installs all required dependencies."
                ]
            },
            {
                "cell_type": "code",
    ...
    # Save notebook
    output_path = 'notebooks/expanded_dataset_training_bulletproof.ipynb'
    with open(output_path, 'w') as f:
        json.dump(notebook, f, indent=2)
    
    print(f"✅ Created bulletproof notebook: {output_path}")
    print("🔧 Key fixes applied:")
    print("   - NumPy 1.x forced installation")
