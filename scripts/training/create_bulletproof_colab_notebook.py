...
"# BULLETPROOF: Load combined dataset with automatic path detection\n",
                    ...
                    "    os.path.join(
                                      repo_path,
                                      'data',
                                      'cmu_mosei_emotion_dataset.json')\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    print(
                               f\"⚠️ Only {len(combined_samples)} samples loaded! Creating comprehensive fallback dataset...\")\n",
                               
                    "    \n",
" # Create comprehensive fallback dataset with 12 samples per emotion\n",
                    "    fallback_samples = [\n",
                    "        # Happy samples\n",
" {\"text\": \"I'm feeling really happy today! Everything is going well.\", \"emotion\":
\"happy\"},\n",
" {\"text\": \"I'm so excited about this amazing news!\", \"emotion\": \"happy\"},\n",
" {\"text\": \"Today has been absolutely wonderful!\", \"emotion\": \"happy\"},\n",
" {\"text\": \"I'm thrilled with how things are working out!\", \"emotion\":
\"happy\"},\n",
...
" {\"text\": \"I'm feeling pure joy right now!\", \"emotion\": \"happy\"},\n",
                    "        \n",
                    "        # Frustrated samples\n",
" {\"text\": \"I'm so frustrated with this project. Nothing is working.\", \"emotion\":
\"frustrated\"},\n",
" {\"text\": \"This is driving me crazy!\", \"emotion\": \"frustrated\"},\n",
" {\"text\": \"I'm getting really annoyed with this situation.\", \"emotion\":
\"frustrated\"},\n",
...
" {\"text\": \"I'm really frustrated with the lack of progress.\", \"emotion\":
\"frustrated\"},\n",
...
" {\"text\": \"This is beyond frustrating!\", \"emotion\": \"frustrated\"},\n",
                    "        \n",
                    "        # Anxious samples\n",
" {\"text\": \"I feel anxious about the upcoming presentation.\", \"emotion\":
\"anxious\"},\n",
" {\"text\": \"I'm worried about what might happen.\", \"emotion\": \"anxious\"},\n",
" {\"text\": \"I'm feeling nervous about this situation.\", \"emotion\":
\"anxious\"},\n",
" {\"text\": \"I'm anxious about the future.\", \"emotion\": \"anxious\"},\n",
" {\"text\": \"I'm feeling uneasy about this.\", \"emotion\": \"anxious\"},\n",
" {\"text\": \"I'm worried about making the right decision.\", \"emotion\":
\"anxious\"},\n",
...
" {\"text\": \"I'm anxious about the unknown.\", \"emotion\": \"anxious\"},\n",
                    "        \n",
                    "        # Grateful samples\n",
" {\"text\": \"I'm grateful for all the support I've received.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm thankful for this opportunity.\", \"emotion\": \"grateful\"},\n",
" {\"text\": \"I'm so grateful for my friends and family.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm thankful for all the blessings in my life.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm grateful for this amazing experience.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm thankful for the lessons I've learned.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm grateful for the people who believe in me.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm thankful for this moment.\", \"emotion\": \"grateful\"},\n",
" {\"text\": \"I'm grateful for the challenges that made me stronger.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm thankful for the beauty in everyday life.\", \"emotion\":
\"grateful\"},\n",
" {\"text\": \"I'm grateful for the love I receive.\", \"emotion\": \"grateful\"},\n",
" {\"text\": \"I'm thankful for this journey.\", \"emotion\": \"grateful\"},\n",
                    "        \n",
                    "        # Overwhelmed samples\n",
" {\"text\": \"I'm feeling overwhelmed with all these tasks.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"This is too much to handle right now.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"I'm feeling swamped with responsibilities.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"I'm drowning in all this work.\", \"emotion\": \"overwhelmed\"},\n",
" {\"text\": \"I'm feeling buried under all these tasks.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"This is overwhelming me completely.\", \"emotion\": \"overwhelmed\"},\n",
" {\"text\": \"I'm feeling crushed by all this pressure.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"I'm feeling suffocated by all these demands.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"This is too overwhelming to process.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"I'm feeling buried alive by all this work.\", \"emotion\":
\"overwhelmed\"},\n",
" {\"text\": \"I'm feeling completely overwhelmed.\", \"emotion\": \"overwhelmed\"},\n",
" {\"text\": \"This is just too much for me.\", \"emotion\": \"overwhelmed\"},\n",
                    "        \n",
                    "        # Proud samples\n",
" {\"text\": \"I'm proud of what I've accomplished so far.\", \"emotion\":
\"proud\"},\n",
...
" {\"text\": \"I'm feeling forlorn.\", \"emotion\": \"sad\"},\n",
                    "        \n",
                    "        # Excited samples\n",
" {\"text\": \"I'm excited about the new opportunities ahead.\", \"emotion\":
\"excited\"},\n",
...
" {\"text\": \"I'm euphoric about this new opportunity!\", \"emotion\":
\"excited\"},\n",
...
" {\"text\": \"I'm feeling peaceful and content.\", \"emotion\": \"calm\"},\n",
                    "        \n",
                    "        # Hopeful samples\n",
" {\"text\": \"I'm hopeful that things will get better.\", \"emotion\":
\"hopeful\"},\n",
...
" {\"text\": \"I'm satisfied with the current situation.\", \"emotion\":
\"content\"},\n",
" {\"text\": \"I'm pleased with how things are.\", \"emotion\": \"content\"},\n",
" {\"text\": \"I'm comfortable with the way things are.\", \"emotion\":
\"content\"},\n",
...
" {\"text\": \"I'm satisfied with how things turned out.\", \"emotion\":
\"content\"}\n",
                    "    ]\n",
                    "    \n",
                    "    combined_samples = fallback_samples\n",
                    "    print(
                               f\"✅ Created {len(combined_samples)} comprehensive fallback samples\")\n",
                               
                    "\n",
                    "print(
                           f\"📊 Final dataset size: {len(combined_samples)} samples\")\n",
                           
                    "\n",
                    "# Verify we have enough data\n",
                    "if len(combined_samples) < 50:\n",
                    "    raise Exception(
                                         f\"Insufficient data! Only {len(combined_samples)} samples. Need at least 50.\")"
                ]
            },
            {
                "cell_type": "code",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    callbacks=[EarlyStoppingCallback(
                                                          early_stopping_patience=2)]  # Shorter patience\n",
