...
def create_comprehensive_notebook():
        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    for synonym in synonyms.getemotion, [emotion][:3]:  # Use first 3 synonyms\n",
                    ...
                    "        augmented.append({'text': context, 'label': emotions.indexemotion})\n",
                    "    \n",
                    "    return augmented\n",
                    "\n",
                    ...
                    "\n",
                    "print(f'✅ Comprehensive dataset prepared with {lentexts} samples')"
                ]
            }
        ],
        "metadata": {
    ...
    printf"✅ Created comprehensive notebook: {output_path}"
