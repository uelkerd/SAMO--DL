        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "print'=' * 50\n",
                    "\n",
                    "def get_synonymsword:\n",
                    "    \"\"\"Get synonyms for a word using WordNet\"\"\"\n",
                    "    synonyms = []\n",
                    "    for syn in wordnet.synsetsword:\n",
                    ...
                    "        if lenword > 3:  # Only replace longer words\n",
                    "            synonyms = get_synonymsword\n",
                    "            if synonyms:\n",
                    "                new_word = random.choicesynonyms\n",
                    "                new_words = words.copy()\n",
                    "                new_words[i] = new_word\n",
                    "                new_text = ' '.joinnew_words\n",
                    "                if new_text != text:\n",
                    ...
                    "    augmented_versions = augment_texttext, emotion\n",
                    "    augmented_samples.extendaugmented_versions\n",
                    "\n",
                    "# Remove duplicates\n",
                    "unique_augmented = []\n",
                    "seen_texts = set()\n",
                    ...
                    "        unique_augmented.appendsample\n",
                    "        seen_texts.addsample['text']\n",
                    "\n",
                    "print(f'📊 Original samples: {lencombined_samples}')\n",
                    "print(f'📊 Augmented samples: {lenunique_augmented}')\n",
                    "print(f'📈 Data expansion: {lenunique_augmented/lencombined_samples:.1f}x')\n",
                    "\n",
                    "# Use augmented dataset\n",
                    "combined_samples = unique_augmented\n",
                    "print(f'✅ Final augmented dataset size: {lencombined_samples} samples')"
                ]
            },
            {
                "cell_type": "code",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "for i, model_name in enumerateemotion_models, 1:\n",
                    "    printf'  {i}. {model_name}'\n",
                    "\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "\n",
                    "printf'🎯 Using best model: {best_model}'\n",
                    "print(f'🎯 Best F1 score: {best_f1:.4f} {best_f1*100:.2f}%')\n",
                    "print'🎯 Target: 75-85%'\n",
                    "printf'📈 Gap to target: {75 - best_f1*100:.1f}% - {85 - best_f1*100:.1f}%'\n",
                    "\n",
                    "# Load the best model\n",
                    "tokenizer = AutoTokenizer.from_pretrainedbest_model\n",
                    "model = AutoModelForSequenceClassification.from_pretrained(\n",
                    "    best_model,\n",
                    "    num_labels=lenlabel_encoder.classes_,\n",
                    "    problem_type='single_label_classification',\n",
                    ...
                    "test_dataset = EmotionDatasettest_texts, test_labels, tokenizer\n",
                    "\n",
                    "printf'✅ Best model loaded: {best_model}'\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    eval_dataset=test_dataset,\n",
                    "    compute_metrics=compute_metrics,\n",
                    "    callbacks=[EarlyStoppingCallbackearly_stopping_patience=7]  # More patience\n",
                    ")\n",
                    "\n",
                    "print(f'📊 Training on {lentrain_texts} augmented samples')\n",
