        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    )\n",
                    "    printf'✅ Specialized model loaded: {model_name}'\n",
                    "except Exception as e:\n",
                    "    printf'⚠️ Could not load {model_name}: {e}'\n",
                    ...
                    "        problem_type='single_label_classification'\n",
                    "    )\n",
                    "    printf'✅ Fallback model loaded: {model_name}'\n",
                    "\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    callbacks=[EarlyStoppingCallbackearly_stopping_patience=5]  # More patience\n",
                    ")\n",
                    "\n",
                    "print(f'📊 Training on {lentrain_texts} samples')\n",
                    "print(f'🧪 Evaluating on {lentest_labels} samples')\n",
                    "printf'🎯 Using specialized model: {model_name}'\n",
                    "\n",
                    "# Start training\n",
                    "trainer.train()"
                ]
