        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "if not os.path.existsdata_path:\n",
                    "    printf'❌ Data directory not found: {data_path}'\n",
                    "    raise Exception'Data directory not found!'\n",
                    "\n",
                    "printf'✅ Data directory found: {data_path}'\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "\n",
                    "# Load journal data\n",
                    "journal_path = os.path.joinrepo_path, 'data', 'journal_test_dataset.json'\n",
                    "try:\n",
                    ...
                    "    printf'⚠️ Could not load journal data: {journal_path} not found.'\n",
                    "\n",
                    "# Load CMU-MOSEI data\n",
                    "cmu_path = os.path.joinrepo_path, 'data', 'cmu_mosei_balanced_dataset.json'\n",
                    "try:\n",
                    ...
                    "except FileNotFoundError:\n",
                    "    printf'⚠️ Could not load CMU-MOSEI data: {cmu_path} not found.'\n",
                    "\n",
                    "print(f'📊 Total combined samples: {lencombined_samples}')\n",
                    "\n",
                    "# BULLETPROOF: Use UNIQUE fallback dataset if needed\n",
                    "if lencombined_samples < 100:\n",
                    "    print(f'⚠️ Only {lencombined_samples} samples loaded! Using UNIQUE fallback dataset...')\n",
                    "    \n",
                    "    # Load the unique fallback dataset\n",
                    "    fallback_path = os.path.joinrepo_path, 'data', 'unique_fallback_dataset.json'\n",
                    "    try:\n",
                    "        with openfallback_path, 'r' as f:\n",
                    "            fallback_data = json.loadf\n",
                    "        combined_samples = fallback_data\n",
                    "        print(f'✅ Loaded {lencombined_samples} UNIQUE fallback samples')\n",
                    "    except FileNotFoundError:\n",
                    "        printf'❌ Could not load unique fallback dataset: {fallback_path}'\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    ")\n",
                    "\n",
                    "print(f'✅ Model initialized with {lenlabel_encoder.classes_} labels')\n",
                    "\n",
                    "# Create datasets\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    callbacks=[EarlyStoppingCallbackearly_stopping_patience=2]\n",
                    ")\n",
                    "\n",
                    "print(f'📊 Training on {lentrain_texts} samples')\n",
                    "print(f'🧪 Evaluating on {lentest_labels} samples')\n",
                    "\n",
                    "# Start training\n",
                    "trainer.train()"
                ]
