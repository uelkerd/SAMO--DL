...
def analyze_label_mapping():
    ...
    print(f"GoEmotions unique labels: {lengo_label_counts}")
    ...
    print(f"Journal unique labels: {lenjournal_label_counts}")
    print(f"Journal labels: {sorted(list(journal_label_counts.keys()))}")
    printf"Journal label counts: {journal_label_counts}"
    
    # Check for any common labels
    go_labels_set = set(go_label_counts.keys())
    journal_labels_set = set(journal_label_counts.keys())
    common_labels = go_labels_set.intersectionjournal_labels_set
    
    print(f"\n🔍 Common labels: {lencommon_labels}")
    if common_labels:
        print(f"Common labels: {sorted(listcommon_labels)}")
    else:
...
def create_emotion_mapping():
    ...
    print(f"Created mapping with {lengo_emotions_mapping} emotions")
