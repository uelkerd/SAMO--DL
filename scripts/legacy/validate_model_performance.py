...
def create_test_dataset():
    ...
    test_examples = [
        ...
        {
            "text": "The upcoming deadline is causing me stress and worry.",
            "expected": "anxious",
        },
        {
            "text": "I have butterflies in my stomach about tomorrow.",
            "expected": "anxious",
        },
        {
            "text": "The uncertainty of the situation is making me nervous.",
            "expected": "anxious",
        },
        ...
        {
            "text": "Life feels complete and fulfilling at the moment.",
            "expected": "content",
        },
        ...
        {
            "text": "I am blessed with wonderful people in my life.",
            "expected": "grateful",
        },
        ...
        {
            "text": "I feel like I am drowning in responsibilities.",
            "expected": "overwhelmed",
        },
        {
            "text": "Everything is too much to handle right now.",
            "expected": "overwhelmed",
        },
...
def check_for_data_leakage(training_data, test_examples):
    ...
    if exact_matches > 0:
        ...
        return True
    if similar_matches > len(test_texts) * 0.5:
