...
def test_focal_loss_math():
    ...
    try:
        class SimpleFocalLossnn.Module:
        ...
        focal_loss = SimpleFocalLossalpha=0.25, gamma=2.0
...
def test_dataset_loading():
    ...
    try:
        ...
        train_size = lendatasets["train"]
        val_size = lendatasets["validation"]
...
def test_model_creation():
    ...
    try:
        ...
        logger.info("   • Model type: {typemodel.__name__}")
