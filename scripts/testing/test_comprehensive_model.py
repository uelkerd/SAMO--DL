...
metadata["performance"]["confidence_range"] = f"{min_confidence:.3f} -
{max_confidence:.3f}"
            metadata["status"] = "ready"
metadata["notes"] = f"Comprehensive model tested successfully. Accuracy:
{accuracy:.2f}%, Confidence: {average_confidence:.3f}"
