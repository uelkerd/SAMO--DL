...
(                })
    ...
    print("Overall Success: {" PASS' if summary['overall_success'] else '❌ FAIL'}")"
    print("Tests Passed: {summary["passed_tests']}")"
    print("Tests Failed: {summary["failed_tests']}")"
    ...
    print("-" * 30)
        ...
        print(f"{test_name.upper()}: {status}")
                ...
                print("  Avg Response Time: {result["avg_response_time']:.3f}s")"
                print("  Success Rate: {result["success_rate']:.1%}")"
