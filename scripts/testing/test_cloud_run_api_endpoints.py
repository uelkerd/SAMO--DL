...
class CloudRunAPITester:
    ...
    def test_invalid_inputs(self) -> Dict[str, Any]:
        ...
        return {
            "success": len(expected_failures)
            > 0,  # At least some inputs should be rejected
            "total_tests": len(results),
    ...
    def test_performance(self) -> Dict[str, Any]:
        ...
        success_rate = (
            len(successful_requests) / len(performance_results)
    ...
    def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        test_results["tests"]["emotion_detection"] = (
            self.test_emotion_detection_endpoint()
        )
