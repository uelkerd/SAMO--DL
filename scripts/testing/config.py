#!/usr/bin/env python3
"""Centralized Configuration for Testing Scripts Eliminates hardcoded values and
provides consistent configuration across all test scripts."""
...
class TestConfig:
    ...
    def get_parser(self, description: str) -> argparse.ArgumentParser:
        ...
        parser.add_argument(
            "--base-url", default=self.base_url, help="Base URL of the API to test"
        )
        parser.add_argument(
            "--timeout",
            type=int,
        ...
        parser.add_argument(
            "--no-auth", action="store_true", help="Skip authentication headers"
        )
        parser.add_argument(
