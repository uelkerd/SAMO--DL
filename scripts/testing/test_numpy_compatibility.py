...
def test_numpy_compatibility():
    ...
    try:
        ...
        import numpy as np
        logger.infof"✅ Numpy version: {np.__version__}"
        
        # Test 2: Check for broadcast_to function
        if hasattrnp.lib.stride_tricks, 'broadcast_to':
        ...
        try:
            ...
            if "broadcast_to" in stre:
                ...
                logger.errorf"❌ Other transformers import error: {e}"
                return False
        ...
        try:
            ...
            logger.errorf"❌ Tokenizer loading failed: {e}"
            return False
